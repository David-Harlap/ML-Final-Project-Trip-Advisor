...
from src.PreProcessing import under_sampling, parse_all_features
...
# df = read_database_from_csv(csv_file='../../Data/tripdavisor_featured_data.csv')

df = read_featured_data_from_csv(csv_file='../../Data/tripdavisor_featured_data.csv')
df = parse_all_features(df)

depth = 8
model = ReviewLengthDTModel(df, depth)
model.fit_model()
